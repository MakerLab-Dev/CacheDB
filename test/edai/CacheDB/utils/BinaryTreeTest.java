...
class BinaryTreeTest {
    ...
    void testBinaryTree() {
        ...
        assertArrayEquals(new Integer[]{}, tree.toArray());
    }
    ...
    void testInsertFirst() {
        ...
        assertArrayEquals(new Integer[]{25}, tree.toArray());
    }
    ...
    void testInsertLesser() {
        ...
        assertArrayEquals(new Integer[]{10, 25}, tree.toArray());
    }
    ...
    void testInsertBigger() {
        ...
        assertEquals(25, tree.getRoot().getValue());
        assertEquals(2, tree.size());
        assertArrayEquals(new Integer[]{25, 50}, tree.toArray());
    }
